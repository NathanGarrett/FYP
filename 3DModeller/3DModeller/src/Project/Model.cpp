...
// static function to load a texture using lightweight stb_image library (only one path, not split in two)
unsigned int Model::TextureFromFile(const char* filepath, bool gamma)
{
	string filename = string(filepath);
